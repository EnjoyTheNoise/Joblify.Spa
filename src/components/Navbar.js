     ...
     <form className="form-inline ml-auto my-2 my-lg-0">
       ...
       <fieldset class="form-group  my-2 my-lg-0" >
         <div class="form-check">
           ...
           <label class="form-check-label">
               <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios2" value="option2" disabled=""/>
               Pracobiorcy
           </label>
         </div>
       </fieldset>
       <button class="btn btn-secondary mx-3 my-2 my-sm-2" type="submit">Search</button>
     </form> 
     <ul className="navbar-nav ml-auto">
       <li className="nav-item dropdown">
         ...
         <div className="dropdown-menu" aria-labelledby="navbarDropdown">
           <a className="dropdown-item" href="#">Ulubione</a>
           <a className="dropdown-item" href="#">Moje Oferty</a>
           <div className="dropdown-divider"></div>
           <a className="dropdown-item" href="#">Edytuj Profil</a>
         </div>
       </li>
